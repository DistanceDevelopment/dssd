...
### Enhancements/issues yet to do... in order of importance

 - Generating line transect surveys by line length (working on it!)
 - Sort plotting warning Warning in plot.sf(x@samplers, add = add, col = col, pch = pch): ignoring all but the first attribute
