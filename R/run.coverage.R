...
#' @details Coverage can either be calculated as an inclusion
...
#' to be carried out.
#' @param method either 'inclusion' or 'coverage'. If 'inclusion'
...
run.coverage <- function(design, reps = 10, method = 'inclusion', save.transects = ""){
